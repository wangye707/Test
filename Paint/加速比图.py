...
y2=[994,840,794,730,699,622,680,730,790,845,940]
y3=[560,520,498,469,418,399,429,468,599,690,702]
out= []
x1=[1,1.2,1.4,1.6,1.8,2,2.2,2.4,2.6,2.8,3]
for i in range(len(y1)):
    ss = (y1[0]/y1[i] + y2[0]/y2[i] +y3[0]/y3[i]  )/3
    out.append(ss)
plt.plot(x1,out,linewidth=3,color='red'
         ,marker='o',
